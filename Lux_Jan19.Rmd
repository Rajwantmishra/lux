...
#Event Timezone
etimezone<- "EST"
save_file<- "saved_jan19.xlsx"
sent_file <- "sent_jan19.xlsx"
...
datatable(saved_by_org_date,caption="Total Unit Saved in OSS by Org / Date", style = 'bootstrap', class = 'table-bordered table-condensed',autoHideNavigation = TRUE,rownames = FALSE)
}
